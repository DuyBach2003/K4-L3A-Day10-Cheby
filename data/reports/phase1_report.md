...
_Generated at 2026-09-25T09:31:51.813771+00:00_
...
| Dataset fingerprint | c1257bb4d221b2b6 |
| Embedding model | sentence-transformers/all-MiniLM-L6-v2 |
| Chroma collection | papers-baseline (24 docs) |
| Test set | 10 questions (data/eval/test_set.json) |
| Top-k | 4 |
...
- Engine: `great_expectations 1.23.1` (ephemeral context, `add_pandas` + whole-dataframe batch)
...
- Quality gate: **PASSED** — clean data was allowed into the `papers-baseline` collection.
- Freshness: **FRESH** (1/24 rows older than 180 days).
- Baseline hit rate 1.0000, token F1 1.0000: these numbers are the reference for the corruption experiment.
